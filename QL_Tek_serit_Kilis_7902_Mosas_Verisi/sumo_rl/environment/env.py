...
class SumoEnvironment(gym.Env):
    ...
    def __init__(
        ...
        print("SumoEnvironment.CONNECTION_LABEL: ",self.label)
        ...
        if LIBSUMO:
            ...
            # label : calistirilan farkli simulasyonların adını tutar
            #  '--output-file','my_intersection.trips.xml' : buda çalışmadı
            #traci.start(["sumo", "-c", "single-intersection.sumocfg","--tripinfo-output", "my_intersection.trips.xml"])
    ...
    def _start_simulation(self):
        sumo_cmd = [self._sumo_binary,
                     ...
                     "--tripinfo-output", "my_intersection.trips.xml"]
    ...
    def save_csv(self, out_csv_name, run):
        if out_csv_name is not None:
            ...
            df.to_csv(out_csv_name + '_conn{}_run{}'.format(self.label, run) + '.csv',index=False) # index= False
