...
class TrafficSignal:
    ...
    def compute_observation(self):
        ...
        density = self.get_lanes_density() # gelen şeritteki araç sayısının şeridin toplam kapasitesine bölümüdür
...
# BU FONKSİYON DEĞİŞTİRİLEREK FARKLI ÖDÜL REWARD FONKSİYONLARI YAZILABİLİR.
    ...
    def _waiting_time_reward2(self): # Yeni ölçülen toplam bekleme = 0 ise reward 1 değilse 1/toplam bekleme
    ...
    def _waiting_time_reward3(self): # rewarda Toplam bekleme süresi eksi değer olarak verilir.
        ts_wait = sum(self.get_waiting_time())
        reward = -ts_wait
        self.last_measure = ts_wait
        return reward
