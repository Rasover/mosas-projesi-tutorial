...
@date    2007-02-27
@version $Id: networkStatistics.py 14425 2013-08-16 20:11:47Z behrisch $
...
def getBasicStats(verbose, method, vehicles, assignments):
    ...
    assignments[method] = Assign(method, totalVeh, noOfStop, avgNoOfStop, totalTravelTime, totalTravelLength,
